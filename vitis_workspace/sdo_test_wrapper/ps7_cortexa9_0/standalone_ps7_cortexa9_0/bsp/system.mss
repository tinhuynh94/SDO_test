...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ClockDivider
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ClockDivider_LVDS
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = EN_CLK25_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = LEV_SHIFT_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = LVDS_Tx
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = LVDS_Tx_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = Misc_LVDS_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = QSPI_GPIO
END
